...
not_run: Response = WS.sendRequest(findTestObject('User Rest Service/List users'))

Response = WS.sendRequestAndVerify(findTestObject('User Rest Service/List users'))
